...
void ImGui::MyWindow(bool* p_open)
{
    ...
    if (!ImGui::Begin("My Window", p_open, window_flags))
    {
...
void ImGui::ShowTestWindow(bool* p_open)
{
    ...
    static bool show_foo_menu = false;
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        {
            ImGui::MenuItem("Fafarafa", NULL, &show_app_about);
            ImGui::EndMenu();
        }
