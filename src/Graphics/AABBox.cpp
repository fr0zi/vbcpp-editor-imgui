...
const unsigned int AABBox::getVertexCount() const
{
    return _vertices.size();
}

const unsigned int AABBox::getIndexCount() const
{
     return _indices.size();
}

const gfx::Vertex* AABBox::getVerticesData() const
{
    return _vertices.data();
}

const unsigned int* AABBox::getIndicesData() const
{
    return _indices.data();
}

const GLuint& AABBox::getVAO() const
{
    return _VAO;
}

void AABBox::createBufferObjects()
{
